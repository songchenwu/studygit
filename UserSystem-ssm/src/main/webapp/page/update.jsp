...
<html>
  ...
  <body>
     <form action="user_doupdate.action" method="post" style="width:500px;margin:80px auto;">
      <table border="1" >
      	  <tr>
      	  	 <td><font color="red">${requestScope.errorMsg}</font></td>
      	  </tr>
      	  <tr>
      	  	 <td><input type="hidden" name="id" value="${sessionScope.user.id }" />${sessionScope.user.id }</td>
      	  </tr>
      	  <tr>
      	  	 <td><input type="text" name="name"  value="${sessionScope.user.name }" /></td>
      	  </tr>
      	  <tr>
      	  	 <td><input type="text" name="birthday"  value="${sessionScope.user.birthday }"/></td>
      	  </tr>
      	  <tr>
      	  	 <td>
      	  	 <select name="gender">
      	  ...
      	  <tr>
      	  	 <td><input type="text" name="career"  value="${sessionScope.user.career }"></td>
      	  </tr>
      	  <tr>
