...
<div id="navbar" class="wrap">
	<div class="profile">
		您好，${sessionScope.users.vuUsername }
		<span class="return"><a href="vote_list.action">返回列表</a></span>
		<span class="addnew"><a href="vote_read.action">添加新投票</a></span>
	...
	<ul class="list">
		<li>
			...
			<p class="info">共有${sessionScope.optionBean.optionCount } 个选项，已有 ${sessionScope.optionBean.voteUserCount } 个网友参与了投票。</p>
				<ol ${sessionScope.optionBean.voteOptionCount }>
					...
					<li>
						<div class="rate">
							<div class="ratebg"><div class="percent" style='width:<c:choose>
								...
								<c:otherwise><fmt:formatNumber value="${voCount/sessionScope.optionBean.voteUserCount}" 
								type="percent" maxFractionDigits="2"/></c:otherwise>
							</c:choose>'></div></div>
